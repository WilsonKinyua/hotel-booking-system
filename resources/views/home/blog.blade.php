...
@section('content')
    ...
    <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url({{asset('assets/img/bg-img/17.jpg')}});">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="post-thumbnail">
                            <a href="#"><img src="{{asset('assets/img/bg-img/24.jpg')}}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="200ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="#"><img src="{{asset('assets/img/bg-img/25.jpg')}}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="#"><img src="{{asset('assets/img/bg-img/26.jpg')}}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="400ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="#"><img src="{{asset('assets/img/bg-img/27.jpg')}}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <a href="#"><img src="{{asset('assets/img/bg-img/28.jpg')}}" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Post Meta -->
                    ...
                    <div class="roberto-sidebar-area pl-md-4">
                        ...
                        <div class="single-widget-area mb-100">
                            ...
                            <div class="single-recent-post d-flex">
                                ...
                                <div class="post-thumb">
                                    <a href="single-blog.html"><img src="{{asset('assets/img/bg-img/29.jpg')}}" alt=""></a>
                                </div>
                                <!-- Content -->
                                <div class="post-content">
                                    <!-- Post Meta -->
                            ...
                            <div class="single-recent-post d-flex">
                                <!-- Thumb -->
                                <div class="post-thumb">
                                    <a href="single-blog.html"><img src="{{asset('assets/img/bg-img/30.jpg')}}" alt=""></a>
                                </div>
                                <!-- Content -->
                                <div class="post-content">
                                    <!-- Post Meta -->
                            ...
                            <div class="single-recent-post d-flex">
                                <!-- Thumb -->
                                <div class="post-thumb">
                                    <a href="single-blog.html"><img src="{{asset('assets/img/bg-img/31.jpg')}}" alt=""></a>
                                </div>
                                <!-- Content -->
                                <div class="post-content">
                                    <!-- Post Meta -->
                            ...
                            <div class="single-recent-post d-flex">
                                <!-- Thumb -->
                                <div class="post-thumb">
                                    <a href="single-blog.html"><img src="{{asset('assets/img/bg-img/32.jpg')}}" alt=""></a>
                                </div>
                                <!-- Content -->
                                <div class="post-content">
                                    <!-- Post Meta -->
                        ...
                        <div class="single-widget-area mb-100 clearfix">
                            ...
                            <ul class="instagram-feeds">
                                <li><a href="#"><img src="{{asset('assets/img/bg-img/33.jpg')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/bg-img/34.jpg')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/bg-img/35.jpg')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/bg-img/36.jpg')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/bg-img/37.jpg')}}" alt=""></a></li>
                                <li><a href="#"><img src="{{asset('assets/img/bg-img/38.jpg')}}" alt=""></a></li>
                            </ul>
                        </div>

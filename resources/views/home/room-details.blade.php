...
@section('content')
     ...
     <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url({{asset('assets/img/bg-img/' . $room->photo->file)}});">
        <div class="container h-100">
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">{{ $room->name }}</h2>
                        <h2 class="room-price">${{ $room->cost }} <span>/ Per Night</span></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="room-review-area mb-100">
                        ...
                        <div class="single-room-review-area d-flex align-items-center">
                            <div class="reviwer-thumbnail">
                                <img src="{{asset('assets/img/bg-img/53.jpg')}}" alt="">
                            </div>
                        ...
                        <div class="single-room-review-area d-flex align-items-center">
                            <div class="reviwer-thumbnail">
                                <img src="{{asset('assets/img/bg-img/54.jpg')}}" alt="">
                            </div>
                            <div class="reviwer-content">
                                <div class="reviwer-title-rating d-flex align-items-center justify-content-between">
                                    <div class="reviwer-title">
                        ...
                        <div class="single-room-review-area d-flex align-items-center">
                            <div class="reviwer-thumbnail">
                                <img src="{{asset('assets/img/bg-img/55.jpg')}}" alt="">
                            </div>
                            <div class="reviwer-content">
                                <div class="reviwer-title-rating d-flex align-items-center justify-content-between">
                                    <div class="reviwer-title">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="hotel-reservation--area mb-100">
                            ...
                            <a href="{{ route('room.book' , $room->id)}}" class="btn roberto-btn w-100">Book Now</a>
                            </div>
                    </div>
                </div>
            </div>
